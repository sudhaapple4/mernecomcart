...
function ProductLists() {
  ...
  //   console.log('filter, sort, page ',filter, sort, page)
  useEffect(() => {
    const pagination = { _page: page, _limit: ITEMS_PER_PAGE };
    dispatch(fetchProductsByFiltersAsync({ token, filter, sort, pagination }));
  }, [filter, sort, page]);

  useEffect(() => {
    dispatch(fetchBrandsAsync(token));
    dispatch(fetchCategoriesAsync(token));
  }, []);
          ...
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-3">
            ...
            <div className="flex items-center">
              ...
              >
                ...
                <CiCircleList className="h-5 w-5" aria-hidden="true" />
              </button>
              <button
                type="button"
...
const ProductList = memo(ProductLists);
